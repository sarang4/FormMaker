(function() {
  var create_form, delete_form, save_form_data;
  ...
  create_form = function() {
    ...
    error_function = function(obj, txt) {
      return alert('Error in creating form');
    };
    success_function = function(response) {
      if (response.error) {
        return alert('Error in creating form ....');
      } else if (response.success) {
        return alert('creating form ....' + response.form_id);
      }
    };
    ajax_params = {
      url: '/create_form',
  ...
  save_form_data = function() {
    var ajax_params, data_params, data_to_be_send, error_function, form_data, success_function, x, _i, _len;
    data_to_be_send = {};
  ...
  delete_form = function(form_id) {
    ...
    error_function = function(obj, txt) {
      return alert('Error in deleting form');
    };
    success_function = function(response) {
      if (response.error) {
